        ...
        () -> {
          this.createItem.execute(
              ...
              new CreateItemCommand(
                  ...
                  Map.of(Language.PT, "Batata-Frita Rústica", Language.EN, "Rustic French Fries"),
                  Map.of(
                      Language.PT,
          ...
          this.createItem.execute(
              ...
              new CreateItemCommand(
                  ...
                  List.of(),
                  new ImageCommand(List.of(), List.of()),
                  Map.of(Language.PT, "Calabresa Acebolada", Language.EN, "Sausage with Onions"),
                  Map.of(
                      Language.PT,
        ...
        () -> {
          ...
          this.createItem.execute(
              ...
              new CreateItemCommand(
                  ...
                  List.of(),
                  new ImageCommand(List.of(), List.of()),
                  Map.of(Language.PT, "Filé Oswaldo Aranha", Language.EN, "Oswaldo Aranha Steak"),
                  Map.of(
                      Language.PT,
        ...
        () -> {
          ...
          this.createItem.execute(
              ...
              new CreateItemCommand(
                  ...
                  List.of(),
                  new ImageCommand(List.of(), List.of()),
                  Map.of(Language.PT, "Mousse de Maracujá", Language.EN, "Passion Fruit Mousse"),
                  Map.of(
                      Language.PT,
          ...
          this.createItem.execute(
              ...
              new CreateItemCommand(
                  ...
                  List.of(),
                  new ImageCommand(List.of(), List.of()),
                  Map.of(Language.PT, "Quindim Tradicional", Language.EN, "Traditional Quindim"),
                  Map.of(
                      Language.PT,
        ...
        () -> {
          ...
          this.createItem.execute(
              ...
              new CreateItemCommand(
                  ...
                  List.of(),
                  new ImageCommand(List.of(), List.of()),
                  Map.of(Language.PT, "Cerveja Original 600ml", Language.EN, "Original Beer 600ml"),
                  Map.of(
                      Language.PT,
