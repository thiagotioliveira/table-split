...
public class ItemUpdatedEvent implements DomainEvent<ItemUpdatedEvent.ItemUpdatedEventDetails> {
  private final UUID accountId;
  private final UUID itemId;
  private final ItemUpdatedEventDetails details;

  public ItemUpdatedEvent(
      UUID accountId, Item item, long total, long totalActive, long totalInactive) {
    this.accountId = accountId;
    this.itemId = item.getId();
    this.details = new ItemUpdatedEventDetails(item, total, totalActive, totalInactive);
  }
  ...
  @Override
  public ItemUpdatedEventDetails getDetails() {
    return this.details;
  }
  ...
  public static class ItemUpdatedEventDetails {
    ...
    public ItemUpdatedEventDetails(Item item, long total, long totalActive, long totalInactive) {
